...
const barcodegenerator_response_get_GenerateBarcodesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(barcodegenerator_get__read.pending, (state, action) => {
        if (state.api.loading === "idle") {
          state.api.loading = "pending"
        }
      })
      .addCase(barcodegenerator_get__read.fulfilled, (state, action) => {
      ...
      .addCase(barcodegenerator_get__read.rejected, (state, action) => {
        if (state.api.loading === "pending") {
